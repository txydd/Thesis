    ...
    $(".wxj_file_list").on("click", ".wxj_file_info_edit_del", function () {
        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                var uid=data.datasetUid;
                window.open("/viewer/user/transfers?fileName=" + fileName + "&fileNumber=" + fileNumber + "&uid=" + uid);
...
function addAddedList(i, data) {
    ...
    $(".wxj_added_list").append("<tr ><td>" + item_id + "</td><td>" + description + "</td><td>" + revision + "</td><td>" + file_name + "</td><td>" + creator_id + "</td><td>"+release_status+"</td></tr>");
    /*<td class='wxj_res_application delete' data-fileNumber=" + file_number + " data-number=" + number + ">删除</td>*/
...
function addFileList(data) {
    ...
    $(".wxj_addBut_area").before("<div class='col-md-3 file_area_temp'><ul class='wxj_file_info_edit'><li><span>资料编号: </span><span>" + item_id + "</span></li><li><span>资料版本: </span><span>" + revision + "</span></li><li><span>文件名: </span><span>" + file_name + "</span></li><li><span>创建者：</span><span>" + creator_id + "</span></li><li><span>状态：</span><span>" + release_status + "</span></li><li><span>物料号: </span><span>" + matnr + "</span></li><p class='wxj_file_info_edit_del _hand _impDel' data-fileNumber=" + file_number + ">查看</p></ul></div>");
    /*<p class='wxj_file_info_edit_del' data-fileNumber=" + file_number + ">删除</p>*/
}
