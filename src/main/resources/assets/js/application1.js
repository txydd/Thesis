...
function addFileList(data) {
    ...
    $(".wxj_addBut_area").before("<div class='col-md-3 file_area_temp'><ul class='wxj_file_info_edit'><li><span>资料编号: </span><span>" + item_id + "</span></li><li><span>资料版本: </span><span>" + revision + "</span></li><li><span>文件名: </span><span>" + file_name + "</span></li><li><span>创建者：</span><span>" + creator_id + "</span></li><li><span>状态：</span><span>" + release_status + "</span></li><li><span>物料号: </span><span>" + matnr + "</span></li></ul></div>");
