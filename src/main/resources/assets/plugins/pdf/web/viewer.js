      ...
      if (this.textLayerMode !== _ui_utils.TextLayerMode.DISABLE && this.textLayerFactory) {
        ...
        // cwx add start
         ...
         var myDate = new Date();
          ...
          var myTime=myDate.getFullYear()+"/"+month+"/"+nowday+" "+hour+":"+minute+":"+second;
          /*var testTime=myDate.toLocaleDateString();*/

          /*var curr=$("#curr").val();*/
          var curr;
          $.ajax({
              async:false,  //调整为同步请求，可以把函数内的值给外面的变量调用
              url:"/viewer/user/getUser",
              method:"post",
              data:{
